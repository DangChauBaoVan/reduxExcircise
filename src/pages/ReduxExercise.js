...
const CartProductOne = (props) => {
  ...
  const product1 = useSelector((state) => state.cart.products[0]);
  const product = { price: product1.price, qty: product1.qty };
...
const CartProductTwo = (props) => {
  ...
  // Change the price of products in `service/cart/slice.js` to see the effect
  const product2 = useSelector((state) => state.cart.products[1]);
  const product = { price: product2.price, qty: product2.qty };
